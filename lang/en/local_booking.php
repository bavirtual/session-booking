...
$string['lastgradeddate'] = 'Last graded session';
$string['lastsessiondate'] = 'Last booked session';
...
$string['minslotperiodwarning'] = 'Minimum slot period not met. Please make sure all slots are at a minimum of {$a} hours.';
$string['minslotperiodwarningtitle'] = 'Slot time warning';
