...
u = r.substr(o.end, r.length);
 ...
 return !0;
                        ...
                        if ("function" == typeof a.onBeforePaste) {
                            if (!1 === (c = a.onBeforePaste.call(i, r, a))) {
...
r = 0;
 ...
 return a;
                            ...
                            if (a.fuzzy && (e = a.buffer, t = a.pos), (u = w(t, n)).targetMatch && u.targetMatch[0] && void 0 !== v[u.targetMatch[0]]) {
                                ...
                                "year" == f[2]) {
 for (var h = s.getMaskTemplate.call(this, !1, 1, void 0, !0), m = t + 1; m < e.length; m++) {
 e[m] = h[m],
...
g = d("-", r);
 ...
 return !0;
                            ...
                            if (-1 !== p && !0 === n._radixDance && !1 === a && i === n.radixPoint && void 0 !== n.digits && (isNaN(n.digits) || parseInt(n.digits) > 0) && p !== t) {
 return {
...
n = !1;
 ...
 "" !== a.radixPoint && t[0] === a.radixPoint && (o && o.buffer ? o.buffer.shift() : (t.shift(),
                                o = {
                                    refreshFromBuffer: !0,
                                    buffer: n(t)
                                }));
...
o = l(this);
 ...
 return r = t.slice().reverse(),
                                ...
                                if (!0 === a._radixDance) {
                                    ...
                                    if (a.digitsOptional) {
                                        if (0 === s) {
 return (r = t.slice().reverse()).pop(), o.trigger("setvalue", [r.join(""), i.begin >= r.length ? r.length : i.begin]),
                                        !1;
}
                                    } else if (-1 !== s && (i.begin < s || i.end < s || e.keyCode === n.default.DELETE && i.begin === s)) {
...
E = o.seekNext.call(l, -1, void 0, !1);
 ...
 for (var S = E; void 0 !== (x = y.shift());) {
                            ...
                            (g = u.EventHandlers.keypressEvent.call(l, _, !0, !1, i, S)) && void 0 !== g.pos && g.pos !== x && c.validPositions[g.pos] && !0 === c.validPositions[g.pos].match.static) {
 y.push(g.pos);
} else if (!g) {
 break;
}
...
i = this.el;
 ...
 i += "0";
                ...
                function n(e, t, i) {
                    var a = this.opts,
n = this.maskset;
                    if (void 0 !== (t = t || s.call(this, e).match).placeholder || !0 === i) {
...
l = [];
 ...
 if ("" !== o[c].match.def && !0 !== o[c].match.optionality && !0 !== o[c].match.optionalQuantifier && (!0 === o[c].match.static || void 0 === r || !1 !== o[c].match.fn.test(r.match.def, n, e, !0, a)) && (l.push(o[c]),
                            !0 === o[c].match.static && (r = o[c]), l.length > 1 && /[0-9a-bA-Z]/.test(l[0].match.def))) {
 ...
 throw "Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + s.mask;
                            ...
                            if (d === e && void 0 === n.matches) {
                                if (h.push({
                                    ...
                                    cd: m,
                                    mloc: {}
                                }), !0 !== n.optionality || void 0 !== f || !(u.definitions && u.definitions[n.nativeDef] && u.definitions[n.nativeDef].optional || Inputmask.prototype.definitions[n.nativeDef] && Inputmask.prototype.definitions[n.nativeDef].optional)) {
 return !0;
}
                                v = !0, d = e;
...
P = h.length;
                                    if (n = g(n, i, r, f)) {
                                        ...
                                        })), a = h[h.length - 1].match, void 0 !== f || !p(a, x)) {
 return !0;
}
                                        v = !0, d = e;
                                    }
...
j = [];
 ...
 j.push(D.toString());
                                        ...
                                        for (var F = 0; F < j.length; F++) {
                                            ...
                                            var N = S.matches[D];
                                            if (N && o(N, [D].concat(r), f)) {
 n = !0;
} else if (0 === F && (O = !0), N && N.matches && N.matches.length > S.matches[0].matches.length) {
 break;
}
                                            E = h.slice(), d = C, h = [];
...
k = 0;
 ...
 v = s && !0 === f.validPositions[k].match.optionality && void 0 === f.validPositions[k + 1] && (!0 === f.validPositions[k].generatedInput || f.validPositions[k].input == c.skipOptionalPartCharacter && k > 0) ? o.call(l, k, u.call(l, k, p, k - 1)) : f.validPositions[k],
                        h = v.match, p = v.locator.slice(), g.push(!0 === i ? v.input : !1 === i ? h.nativeDef : n.call(l, k, h));
} else {
...
C = -1;
 ...
 break;
                            ...
                            for (S.excludes[m].push(A + ":" + p.alternation), h = m; h < o.getLastValidPosition.call(x, void 0, !0) + 1; h++) {
 delete S.validPositions[h];
}
                        }
                    }
...
_ = g.extend(!0, {}, y.validPositions);
 ...
 void 0 !== y.excludes[w] && (y.excludes[w] = void 0,
                    delete y.tests[w]);
}
}
 ...
 for (var T = x + 1, D = o.seekNext.call(m, x, !1, 0 !== x); T <= D; T++) {
 if (!1 !== (S = E(T, t, i))) {
