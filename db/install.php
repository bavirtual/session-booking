...
function create_course_customfields() {
    ...
    save_course_customfield($category, 'text', 'vatsimrating',  get_string('vatsimrating', 'local_booking'),
        ',"visibility":"0","defaultvalue":"","displaysize":15,"maxlength":50,"ispassword":"0","link":""', get_string('vatsimratingdesc', 'local_booking'));
    ...
    save_course_customfield($category, 'checkbox', 'vatsimintegration', get_string('vatsimintegration', 'local_booking'),
        ',"visibility":"0","checkbydefault":"0"', get_string('vatsimintegrationdesc', 'local_booking'));
}
